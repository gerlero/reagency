...
void Foam::reaction::speciesCoeffs::write
(
    Ostream& os,
...
Foam::reaction::speciesCoeffs::speciesCoeffs
(
    const speciesTable& species,
    Istream& is
)
...
Foam::List<Foam::reaction::speciesCoeffs> Foam::reaction::lhs() const
{
    return lhs_;
}

Foam::List<Foam::reaction::speciesCoeffs> Foam::reaction::rhs() const
{
    return rhs_;
}

Foam::dimensionSet Foam::reaction::YDimensions
(
...
Foam::dimensionSet Foam::reaction::kfDimensions(const dimensionSet& dimY) const
{
    return dimless/(dimTime*pow(dimY, forwardOrder() - 1));
}

Foam::dimensionSet Foam::reaction::krDimensions(const dimensionSet& dimY) const
{
    return dimless/(dimTime*pow(dimY, reverseOrder() - 1));
}

void Foam::reaction::write
(
    Ostream& os,
    const speciesTable& species
)
...
Foam::scalar Foam::reaction::forwardOrder() const noexcept
{
    scalar order = 0;
...
Foam::scalar Foam::reaction::reverseOrder() const noexcept
{
    scalar order = 0;
...
Foam::Pair<Foam::List<Foam::reaction::speciesCoeffs>> 
Foam::reaction::read
(
    const speciesTable& species,
    Istream& is
...
Foam::List<Foam::reaction::speciesCoeffs> Foam::reaction::readSide
(
    const speciesTable& species,
    Istream& is
)
